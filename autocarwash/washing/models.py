...
class Washing(models.Model):
    ...
    car = models.ForeignKey(
        Car, verbose_name='Автомобиль', on_delete=models.CASCADE
        )
    wash = models.ForeignKey(
        Wash, verbose_name='Помывка', on_delete=models.CASCADE
        )
    washing = models.CharField(
        verbose_name='Комментарий к помывке', max_length=21
        )
