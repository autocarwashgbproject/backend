...
class CarDetailSerializer(serializers.ModelSerializer):  # Добавление машины
    ...
    def to_representation(self, data):
        ...
        if subscription_date.exists():
            last_subscription_date = subscription_date.first().subscription_date # format: 2019-09-04 21:05:51.186224+00:00 TESTS (предполодим, что клиент оформила подписку): last_subscription_date = dt(2019, 1, 31)
